...
#if DT_NODE_HAS_STATUS_OKAY(DT_INST(0, test_wdt_errors_case)) && \
DT_PROP(DT_INST(0, test_wdt_errors_case), opt_pause_in_sleep) && \
DT_PROP(DT_INST(0, test_wdt_errors_case), opt_pause_halted_by_dbg)
